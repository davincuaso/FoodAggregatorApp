...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationReader.LocationReaderCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(14.6416137,121.0753909);


        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in ADMU"));


        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(sydney, 16.99f));
    }
}